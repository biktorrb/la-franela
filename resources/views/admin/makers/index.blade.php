        ...
        <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <h1 class="text-2xl font-bold mb-4">Fabricantes</h1>
                    @php
                    $rows = [
                        fn($item) => $item->id,
                        fn($item) => $item->name,
                    ...
                    />
                    <div class="mt-4">
                        <a href="{{ route('admin.makers.create') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white font-semibold rounded hover:bg-blue-700">
                            <i class="fas fa-plus mr-2"></i> Agregar nuevo frabricante
                        </a>
                    </div>
                </div>
            </div>    
